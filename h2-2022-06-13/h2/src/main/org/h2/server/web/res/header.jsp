            ...
            <tr class="toolbar">
                ...
                <td class="toolbar">
                    <input type="checkbox" name="autoCommit" value="autoCommit" onclick=
                        "parent.h2result.document.location='query.do?jsessionid=${sessionId}&amp;sql=@autocommit_' + (document.header.autoCommit.checked ? 'true' : 'false') + '.';"/>
                </td>
                <td class="toolbar">
                ...
                <td class="toolbar">
                    ...
                    "parent.h2result.document.location='query.do?jsessionid=${sessionId}&amp;sql=@maxrows+'+header.rowcount.value+'.';">
                    <option value="0">
                            ${text.toolbar.all}
                        </option>
                        <option value="10000">
                ...
                <td class="toolbar">
                    ...
                    <select name="autoComplete" size="1"
                        onchange="parent.h2query.setAutoComplete(this.value)">
                ...
                <td class="toolbar">
                    ...
                    <select name="autoSelect" size="1"
                        onchange="parent.h2query.setAutoSelect(this.value)">
                        <option value="0">
