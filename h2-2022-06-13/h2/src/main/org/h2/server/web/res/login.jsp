...
<body style="margin: 20px">
    ...
    <p>                    <select name="language" size="1"
                        onchange="document.location='index.do?jsessionid=${sessionId}&amp;language='+login.language.value;"
                    >
                    ${languageCombo}
                    </select>
        ...
        <table class="login" cellspacing="0" cellpadding="0">
            ...
            <tr class="login">
                ...
                <td class="login">
                    <select name="setting" size="1"
                        style="width:300px"
                        onchange="document.location='index.do?jsessionid=${sessionId}&amp;setting='+login.setting.value;"
                    >
                    ${settingsList}
                    </select>
                </td>
            ...
            <tr class="login">
                ...
                <td class="login">
                    ...
                    <input type="button" class="button" value="${text.login.save}" onclick="document.login.action='settingSave.do?jsessionid=${sessionId}';submit()" />
                    <input type="button" class="button" value="${text.login.remove}" onclick="document.login.action='settingRemove.do?jsessionid=${sessionId}';submit()" />
                </td>
            </tr>
            <tr class="login">
            ...
            <tr class="login">
                ...
                <td class="login">
                    ...
                    &nbsp;
                    <input type="button" class="button" value="${text.login.testConnection}" onclick="document.login.action='test.do?jsessionid=${sessionId}';submit()" />
                    <br />
                    <br />
                </td>
            </tr>
