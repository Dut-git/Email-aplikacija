    ...
    <body onresize="sizeTextArea();" onload="sizeTextArea();" style="margin: 0px; padding: 0px;">
        <form name="h2query" action="javascript:alert('should not be submitting this form');">
            <span style="white-space:nowrap">
                <input type="button" class="button" value="${text.toolbar.run}" onclick="submitAll();sql.focus();return true;" />
                <input type="button" class="button" value="${text.toolbar.runSelected}" onclick="submitSelected();sql.focus();return true;" />
                <input type="button" class="button" value="${text.toolbar.autoComplete}" onclick="manualAutoComplete();sql.focus();return true;" />
                <input type="button" class="button" value="${text.toolbar.clear}" onclick="sql.value='';keyUp();sql.focus();return true;" />
